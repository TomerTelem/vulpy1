...
def cmd_api_client(message):
    if not api_key_file.exists():
        ...
        r = requests.post('https://127.0.1.1:5000/api/key', json={'username':username, 'password':password}, timeout=60)
    ...
    r = requests.post('https://127.0.1.1:5000/api/post', json={'text':message}, headers={'X-APIKEY': api_key}, timeout=60)
    print(r.text)
